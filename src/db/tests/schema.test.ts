...
const expectedTables: Record<string, TableSpec> = {
  ...
  tapGestures: {
    ...
    columns: [
      ...
      { name: 'temperature_step_mode', notNull: false, default: undefined },
      ...
      { name: 'feedback_vibration_enabled', notNull: true, default: false },
      { name: 'feedback_vibration_intensity', notNull: false, default: undefined },
      { name: 'feedback_vibration_pattern', notNull: false, default: undefined },
      { name: 'feedback_vibration_duration', notNull: false, default: undefined },
      { name: 'created_at', notNull: true, default: 'sql' },
      { name: 'updated_at', notNull: true, default: 'sql' },
    ],
    indexes: [
  ...
  deviceState: {
    ...
    columns: [
      ...
      { name: 'alarm_state', notNull: true, default: 'idle' },
      { name: 'alarm_occurrence_id', notNull: false, default: undefined },
      { name: 'alarm_schedule_id', notNull: false, default: undefined },
      { name: 'alarm_scheduled_for', notNull: false, default: undefined },
      { name: 'alarm_snoozed_until', notNull: false, default: undefined },
      { name: 'alarm_ringing_until', notNull: false, default: undefined },
      { name: 'alarm_vibration_intensity', notNull: false, default: undefined },
      { name: 'alarm_vibration_pattern', notNull: false, default: undefined },
      { name: 'alarm_duration', notNull: false, default: undefined },
